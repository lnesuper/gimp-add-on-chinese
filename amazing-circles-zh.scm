...
(script-fu-register "script-fu-amazing-circles"
            _"<Image>/Filters/GimpBox/Script-Fu-中文/扭曲/令人惊奇的极坐标旋绕圈(Amazing circles)..."
            "将一个方行图片转化为令人惊奇的极坐标旋绕圈,convert by lnesuper.(Does the amazing circles on a square image)"
            "Harry Phillips"
            "Harry Phillips"
            "Mar. 23 2007"
            "*"
	    ...
	    SF-ADJUSTMENT	_"径向扭曲深度"      '(100 0 100 1 10 1 0)
            SF-COLOR		"环绕颜色" '(255 255 255)
	    SF-OPTION		"修改图像?"		'("修改之后" "修改之前" "不做修改")
)
