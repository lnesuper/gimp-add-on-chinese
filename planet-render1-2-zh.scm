...
(script-fu-register "script-fu-planet-render"
                   _"行星模型(_Planet render)..."
                   "创作一个行星.convert by lnesuper.(颜色,大小和光照方位都被设定)|Creates a planet.(Color, size and sun orientation can be set)"
                   "Aurore D. (Rore)"
                   "aurore.d@gmail.com"
                   "October 2005"
                   ""
                   SF-ADJUSTMENT _"行星大小(像素)" '(400 40 2000 1 10 0 1)
                   SF-COLOR _"行星颜色" '(10 70 100)
                   SF-ADJUSTMENT _"光照方位 (度数) " '(0 0 360 1 10 1 0) 
		   SF-ADJUSTMENT _"光照偏色 " '(1 0 5 1 10 1 0) )
(script-fu-menu-register "script-fu-planet-render"
			 _"<Toolbox>/Xtns/Misc/GimpBox")
