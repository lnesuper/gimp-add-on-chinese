...
(script-fu-register 
	...
	_"减少ISO噪音(ISO _Noise Reduction)"
	"降低传感器噪音(在高ISO值).Reduce sensor noise at high ISO values"
	"Martin Egger (martin.egger@gmx.net)"
	...
	SF-ADJUSTMENT	"图层不透明度"	'(70.0 1.0 100.0 1.0 0 2 0)
	SF-ADJUSTMENT	"模糊半径"	'(5 1.0 10.0 0.5 0 2 0)
